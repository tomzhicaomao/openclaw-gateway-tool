# OpenClaw Gateway 切换工具

macOS 上 OpenClaw Gateway 的开机启动/后台运行管理工具。

## 功能

一键切换 Main Gateway (18789) 和 Rescue Gateway (19001) 两个服务的状态：
...
- `toggle-openclaw.sh` — 主脚本
- `test-toggle-openclaw.bats` — Bats 单元测试（10 个测试用例）
